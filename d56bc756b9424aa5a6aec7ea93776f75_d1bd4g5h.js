...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    let body = { context: { CultureName: "zh-CN", EntCode: "1", OrgCode: "108401", UserCode: "BIP" }, opType: "GetAddress", jsonData: '{"AddressType":"市","ModifiedOn":"2022-01-06"}' };
    let header = {
    ...
    var res = ObjectStore.insertBatch("AT16388E3408680009.AT16388E3408680009.city", dataArr, "ybd0168af6");
    return { sss: res };
  }
}
