...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    if (cs_is_or_not !== null && cs_is_or_not !== undefined) {
      query_sql = query_sql + " and cs_is_or_not = '" + cs_is_or_not + "' ";
    }
    ...
    query_sql = query_sql + " order by class_sort,code limit " + page + "," + size;
