  ...
  execute(request) {
    ...
    function packageBody(bodyData, type) {
      let packageBody = {
        ...
        bodyItem: {
          define1: bodyData.define1,
          define2: bodyData.define2,
          define3: bodyData.define3,
          define4: bodyData.define4,
          define5: bodyData.define5,
          define6: bodyData.define6
        },
        memo: bodyData.memo
      };
      return packageBody;
    ...
    function packageHead(selectData, type) {
      ...
      let bizFlow = "309d2d39-1b54-11ec-8c0b-98039b073634";
    ...
    for (var i = 0; i < bodyRes.length; i++) {
      ...
      if (materRes[0].productClass == "2728415547249920" || materRes[0].productClass == "2728415548364032") {
        //镜架
        isframe = true;
      } else {
        isframe = false;
