run = function (event) {
  ...
  viewModel.on("afterLoadData", function (args) {
    ...
    for (var i = 0; i < rows.length; i++) {
      if (rows[i].doubleCheck == "false" || rows[i].doubleCheck == "0" || rows[i].doubleCheck == 0 || rows[i].doubleCheck == false) {
  ...
  viewModel.on("beforeSave", function (args) {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      //校验密码
      if (rows[i].doubleCheck == "true" || rows[i].doubleCheck == "1" || rows[i].doubleCheck == true || rows[i].doubleCheck == 1) {
