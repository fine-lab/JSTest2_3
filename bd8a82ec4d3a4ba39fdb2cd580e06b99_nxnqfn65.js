...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    for (let prop in itemList) {
      ...
      debuggerParam.params = params;
      let lastDate;
      let urlPrice = "https://www.example.com/" + request.access_token;
      debuggerParam.urlPrice = urlPrice;
      ...
      if ("200" == responseObj.code) {
        ...
        debuggerParam.producturl = producturl;
    ...
    return { itemList: itemList, summary: summary, message: message, debuggerParam: debuggerParam };
  }
}
