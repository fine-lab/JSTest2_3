...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    // 拼装请求报文
    var obj = { tenantId: tenantid, logId: "yourIdHere", time: timestampStr, uuid: sign };
    //获取api前缀等信息 参数： 请求方式 ， 地址  ，header ， body
    var strResponse = postman("post", apiRestPre + "/task/maintainPlanAdd", null, JSON.stringify(obj));
    return { strResponse };
  }
}
