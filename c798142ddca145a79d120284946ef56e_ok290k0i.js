...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var result = [];
    //王霞可以看全部
    if ("A01050002" === usercode) {
      allData = "allmess";
    }
    var token = "";
    let func1 = extrequire("GT90580AT6.backDefaultGroup.Gettoken");
    ...
    return { res: result, allData: allData, orgid: orgid, deptCode: deptCode, usercode: usercode, userid: userid };
  }
}
