  ...
  viewModel.on("modeChange", function (data) {
    if (data === "add" || data == "edit") {
      ...
      for (let i = 0; i < rows.length; i++) {
        gjrkys_getCustomerInfo(rows[i].material, org_id).then((materialInfo) => {
          ...
          let isBatch = materialInfo.detail.isBatchManage;
          let isValid = materialInfo.detail.isExpiryDateManage;
          if ((isBatch == 1 || isBatch == "1" || isBatch == true || isBatch == "true") && (isValid == 1 || isValid == "1" || isValid == true || isValid == "true")) {
            ...
            //保质期
            let expireDateNo = materialInfo.detail.expireDateNo;
            gridModelInfo.setCellValue(i, "shelf_life", expireDateNo);
            //保质期单位
            let expireDateUnit = materialInfo.detail.expireDateUnit;
            gridModelInfo.setCellValue(i, "expire_date_unit", expireDateUnit);
          ...
          } else if ((isBatch == 1 || isBatch == "1" || isBatch == true || isBatch == "true") && (isValid == 0 || isValid == "0" || isValid == false || isValid == "false")) {
            ...
            gridModelInfo.setCellValue(i, "is_bath_manage", trueOfFalse(isBatch));
            gridModelInfo.setCellValue(i, "is_expire_manage", trueOfFalse(isValid));
          } else if ((isBatch == 0 || isBatch == "0" || isBatch == false || isBatch == "false") && (isValid == 0 || isValid == "0" || isValid == false || isValid == "false")) {
