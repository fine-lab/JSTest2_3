...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    let access_token = getToken("838cb56cbfae42f7ab7da889aefc34aa", "cde7ad5cad8c434eabec2f558f4c4ad5");
    ...
    let header = {
      ...
      // 就是appCode
      apicode: "cde7ad5cad8c434eabec2f558f4c4ad5",
      appkey: "yourkeyHere"
    };
    let apiResponse = apiman("post", "https://www.example.com/" + access_token, JSON.stringify(header), JSON.stringify(body));
    let apiRese = JSON.parse(apiResponse);
    if (apiRese.data.resultBalance[0].balance - data.rebateMoney < 0) {
      throw new Error("此来源单号的政策申请金额已不足");
    }
    return {};
    //获取token
