...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var sql = "select * from GT60601AT58.GT60601AT58.issuingContract where dr=0 and issuingContract_status in(1,2) and verifystate=2 and contract_due_date='" + nowstr + "'";
    ...
    for (var i = 0; i < res.length; i++) {
      ...
      var channels = ["uspace"];
      var title = "出证合同到期预警";
      var content = "出证合同号【" + data.receiContract_code + "】,30天后即将过期";
      var messageInfo = {
        sysId: "yourIdHere",
        tenantId: "yourIdHere",
