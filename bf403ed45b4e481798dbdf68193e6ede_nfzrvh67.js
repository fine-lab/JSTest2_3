...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var PurDATES = PurDATEES(access_token, request.code, request.pageSize, request.pageIndex);
    //获取采购接口方法
    function PurDATEES(access_token, code, pageSize, pageIndex) {
      //设置返回的access_token
      // 获取token的url
