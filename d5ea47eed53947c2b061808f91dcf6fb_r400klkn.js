run = function (event) {
  ...
  let updateViewModel = function (gridModelInfo, i, materialInfo) {
    gridModelInfo.setCellValue(i, "gsp_material_type", materialInfo.materialType);
    gridModelInfo.setCellValue(i, "gsp_material_type_catagoryname", materialInfo.materialTypeName);
