...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    for (let prop in itemList) {
      let rangeUrl = gatewayurl + "/yonbip/digitalModel/product/list?access_token=" + request.access_token;
      let rangeParam = {
        enable: "1",
        pageIndex: 1,
        pageSize: 10,
      ...
      let url = gatewayurl + "/yonbip/digitalModel/product/detail?access_token=" + request.access_token + "&id=" + itemList[prop]["pdGiftInv"] + "&productApplyRangeId=" + rangeId;
      ...
      let lastDate;
      let urlPrice = gatewayurl + "/yonbip/sd/goods/price/customerproduct/list?access_token=" + request.access_token;
