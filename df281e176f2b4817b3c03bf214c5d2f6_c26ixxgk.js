...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var queryDefSql = " select define4 from voucher.invoice.SaleInvoiceFreeItem where id in (select id from voucher.invoice.SaleInvoice where status in('0','3') )";
