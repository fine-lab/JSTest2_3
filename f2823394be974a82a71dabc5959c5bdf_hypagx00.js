...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    var queryStoreID = param.storeID;
    var queryDate = param.date;
    ...
    console.log("返回信息: {}", queryResponseJson);
    ...
    if (queryCode == "10000") {
      ...
      settleMethodList.forEach((settleMethod) => {
        ...
        } else if (settleMethod.settleMethodId_name == "银行卡") {
