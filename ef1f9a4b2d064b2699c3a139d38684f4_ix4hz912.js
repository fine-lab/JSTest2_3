...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let voucherJsonApiUrl = "https://www.example.com/" + tid + "/selfApiClass/glSelfApi/voucherJsonApi"; //发布的保存凭证json的接口
    let logToDBUrl = "https://www.example.com/" + tid + "/selfApiClass/glSelfApi/logToDB"; //发布的写日志接口
    let addVoucherUrl = DOMAIN + "/yonbip/fi/ficloud/openapi/voucher/addVoucher"; //添加凭证接口
    let delVoucherUrl = DOMAIN + "/yonbip/fi/voucher/del"; //删除凭证接口
