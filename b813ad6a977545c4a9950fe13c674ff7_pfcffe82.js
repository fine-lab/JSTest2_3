...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var url = `https://api.diwork.com/yonbip/digitalModel/staff/detail?access_token=${access_token}&id=1989497898602752`;
    var strResponse0 = postman("get", url, null, null);
    return { aaa: 111, strResponse0 };
  }
}
