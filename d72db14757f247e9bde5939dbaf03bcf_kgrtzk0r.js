...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var apiResponse = openLinker("POST", url, "AT18DC6E5E09E00008", JSON.stringify(body)); //TODO：注意填写应用编码(请看注意事项)
    ...
    var res = ObjectStore.insertBatch("AT18DC6E5E09E00008.AT18DC6E5E09E00008.CustomerData", objects, "CustomerData");
    return {};
  }
}
exports({
