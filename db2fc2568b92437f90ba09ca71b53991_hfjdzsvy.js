...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    if (isSourceOrder == 1) {
      ...
      let productPacking = ObjectStore.selectByMap("I0P_UDI.I0P_UDI.sy01_udi_product_configurev3", { bzcpbs: productPackingLogo }); //查询包装产品标识
      if (productPacking == null || productPacking.length == 0) {
        throw new Error("没有对应包装产品标识！");
      }
      //查询生成规则
      let udiCreateConfig = ObjectStore.selectByMap("I0P_UDI.I0P_UDI.sy01_udi_create_config_sonv3", { sy01_udi_create_config_id: productPacking[0].udiCreateConfigId });
