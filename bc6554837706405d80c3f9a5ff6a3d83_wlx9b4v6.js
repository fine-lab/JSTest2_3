...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let gongsimingchen = data.gongsimingchen;
    let customercode = data.code;
    let id = data.id;
    let qiyekubianma = data.qiyeku_id;
    let qiyeku_name = data.qiyeku_name;
    let qiyeku = data.qiyeku;
    ...
    if (queryCodeqiye !== "200") {
      ...
      if (ccode === undefined && gongsimingchen !== undefined) {
        //如果没有被定义就新增保存
        let header = {
        ...
        if (queryCode1 !== "200") {
          ...
          var retobj = ObjectStore.updateById("GT56481AT32.GT56481AT32.QYK", object);
        }
      }
    }
    //获取token方法
