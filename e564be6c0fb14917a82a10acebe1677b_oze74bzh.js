...
class MyAPIHandler extends AbstractAPIHandler {
  execute(context, param) {
    var date = new Date();
    var data = {};
    data.appid = "youridHere";
    data.content = "提交了一个新工单请查看";
    data.highlight = "新工单";
    data.yhtUserIds = "['ecad52e4-b1a1-4b38-b95e-a40c1a65db78']";
    data.tenantId = "yourIdHere";
    data.sendScope = "list";
    data.title = "消息提醒";
    data.esnData = '{"ecad52e4-b1a1-4b38-b95e-a40c1a65db78"}';
    var ay = "e1c22d34e26c4bcbac282c70c69240bf";
    var ac = "17bc3af31b134cb48cc5b534852f58fd";
    var act = getToken(ay, ac);
    var strResponse = postman("post", "https://www.example.com/" + act + "&", null, JSON.stringify(data));
