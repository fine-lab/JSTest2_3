...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    try {
      ...
      let configure2 = "select * from ISVUDI.ISVUDI.sy01_udi_product_configurev2  where bzcpbs = " + request.proCode + " and dr = 0";
      ...
      let proInfo =
        "select *,product.productDetail.isSerialNoManage isSerialNoManage,product.productDetail.isBatchManage isBatchManage,product.productDetail.isExpiryDateManage isExpiryDateManage from ISVUDI.ISVUDI.sy01_udi_product_infov2 where id =  " +
      ...
      //获取主表信息
      let productUDISql = "select * from ISVUDI.ISVUDI.sy01_udi_relation_productv2 where id = " + proRes[0].sy01_udi_relation_product_id + " and dr = 0";
      ...
      //获取产品标识库信息
      let productUDIListSql = "select * from ISVUDI.ISVUDI.sy01_udi_product_listv2 where id = " + udiProListRs[0].productUdi + " and dr = 0";
