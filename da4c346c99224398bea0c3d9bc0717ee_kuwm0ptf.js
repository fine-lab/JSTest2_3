...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var approveMan = request.approveMan;
    var approveDateTime = request.approveTime;
    var status = "";
    if (processEnd == "true") {
      status = "审批通过";
    ...
    //通过billId找到单据的真实id
    var param = { id: billId, approveStatus: status, approveResult: approveResult, approveMan: approveMan, approveDateTime: approveDateTime };
