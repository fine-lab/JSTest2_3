class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    function getToken(yourappkey, yourappsecrect) {
      ...
      var access_token;
      // 获取token的url
      const token_url = "http://222.134.95.58:8088/nccloud/opm/accesstoken";
