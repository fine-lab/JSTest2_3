      ...
      if (res1[i].trainType == "4") {
        ...
        for (var j = 0; j < res.length; j++) {
          ...
          if (res2[0]) {
            ...
            res[j] = res1[i].id;
            ObjectStore.updateById("GT42921AT2.GT42921AT2.buildma_info", res[j], "096903d0");
        ...
        for (var j = 0; j < res.length; j++) {
          ...
          if (res2[0]) {
            res[j]["throughTrainType"] = res2[0].throughTrainType;
            res[j] = res1[i].id;
            var i = ObjectStore.updateById("GT42921AT2.GT42921AT2.buildma_info", res[j], "096903d0");
