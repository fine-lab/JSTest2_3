...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    function aftsv(act, args, url) {
      ...
      if (agsdata.length != 0) {
        if (args["data"][0]["fund_usedirection_name"] != "工作经费") {
          ...
          var strResponse = postman("post", "".concat(url, act, "&custdocdefid=2167960314450432"), null, JSON.stringify(data));
          var prt_dat = {};
          prt_dat.data = {};
          prt_dat.data.id = id;
          ...
          prt_dat.data._status = "Insert";
          var prt_url = "https://www.example.com/";
          var prt_res = postman("post", "".concat(prt_url, act, "&"), null, JSON.stringify(prt_dat));
        } else {
          var code = args["data"][0]["code"];
          var name = args["data"][0]["name"];
          var orgid = args["data"][0]["org_id"];
    ...
    var ay = "e1c22d34e26c4bcbac282c70c69240bf";
    var ac = "17bc3af31b134cb48cc5b534852f58fd";
